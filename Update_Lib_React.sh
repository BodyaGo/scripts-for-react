...
# Function to update React libraries
function update_react_libraries {
  printf "${YELLOW}Updating React libraries...${NC}\n"
  npm update react react-dom
  printf "${GREEN}React libraries updated successfully!${NC}\n"
}
